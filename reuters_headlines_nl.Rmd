---
title: "Sentiment analysis on news headlines, 2011-2017"
output:
  html_document:
    df_print: paged
---
...
First, we load necessary libraries and one useful dataset, stop_words. We'll use it to exclude English stop words from analysed headlines, as they are of little interest for us.
...
```{r, echo = FALSE}
dreut = read.csv("D:/kaggle/reuters/dreut.csv", 
                 stringsAsFactors = FALSE, header = TRUE)

dreut = mutate(dreut, pdt = as.Date(pdt, "%Y-%m-%d") )
```
...
<hr>
<br>
<h2> Part 1: good news, bad news </h2>
...
```{r, message = FALSE, warning = FALSE, fig.align = 'center', fig.width = 10, fig.height = 8}
